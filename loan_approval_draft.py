...
# param_grid = {
#   'n_estimators': [int(i) for i in range(40, 120, 20)],
#   'max_depth': [int(i) for i in range(2, 12)],
#   'learning_rate': [0.1, 0.01]
# }

# sample_weights = compute_sample_weight(class_weight='balanced', y=y_train)
# scorer = make_scorer(recall_score)
# grid_search = GridSearchCV(gb_classifier, param_grid, scoring=scorer, cv=StratifiedKFold(n_splits=5), verbose=2)
...
gb_classifier = GradientBoostingClassifier(n_estimators=130, learning_rate=0.25, random_state=42)
